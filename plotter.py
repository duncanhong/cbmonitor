...
NS_STATS_OT = ["cpu_utilization_rate", "opsPerSec", "diskUsed", "dataUsed", "replication_docs_rep_queue",
               "xdc_ops", "ep_cache_miss_rate", "replication_changes_left", "replication_docs_checked",
               "ep_num_ops_get_meta", "ep_num_ops_del_meta", "ep_num_ops_set_meta", "replication_data_replicated", "replication_size_rep_queue"]
